...
<body>
    ...
    // Loop through each row and output the data
         while($row = $result->fetch_assoc()) {
             ...
             // . "Mileage: " . $row["mileage"] . "Color: " . $row["color"] . "<br>" . "State";
              echo "<tr>";
              echo "<td style='color:#FFFF00'>".$row['record_number']."</td>";
              echo "<td style='color:#00FF00'>".$row['company']."</td>";
              echo "<td style='color:#00FF00'>".$row['model']."</td>";
              echo "<td style='color:#00FF00'>".$row['year']."</td>";
              echo "<td style='color:#00FF00'>".$row['price']."</td>";
              echo "<td style='color:#00FF00'>".$row['mileage']."</td>";
              echo "<td style='color:#00FF00'>".$row['color']."</td>";
              echo "<td style='color:#00FF00'>".$row['state']."</td>";
              echo "</tr>";
         }
